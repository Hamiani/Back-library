...
@ControllerAdvice
public class RhCoreExceptionHandler extends ResponseEntityExceptionHandler {

	public RhCoreExceptionHandler() {
		super();
	}
	...
	// 422
	@ExceptionHandler(value = { EntityExistsException.class, MyResourceAlreadyExistsException.class })
	protected ResponseEntity<Object> handleAlreadyExists(final RuntimeException ex, final WebRequest request) {
		final String bodyOfResponse = ex.getMessage();
		return this.handleExceptionInternal(ex, bodyOfResponse, new HttpHeaders(), HttpStatus.UNPROCESSABLE_ENTITY,
				request);
	}
